...
const OurPurpose = () => {
    ...
    const [content, setContent] = useState([
        ...
        {icon: <BiBrain />, main: "Impactful Learning Experiences", sub: "We are committed to creating impactful learning experiences that go beyond the traditional classroom. Our courses are designed to be interactive, engaging, and relevant to today's job market."}, 
